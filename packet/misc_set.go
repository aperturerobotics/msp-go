...
// MspSetMisc contains misc data for the FC.
// Direction: ->FC
// MessageID: 207
type MspSetMisc struct {
...
func (p *MspSetMisc) New() Packet {
	return &MspSetMisc{}
}

// GetID returns this packet ID.
func (p *MspSetMisc) GetID() uint8 {
	return 207
}

// Marshal marshals the packet to a byte array.
func (p *MspSetMisc) Marshal() ([]byte, error) {
	return writeLSBBuf(
		&p.PowerTrigger,
		&p.MinThrottle,
		&p.MaxThrottle,
...
func (p *MspSetMisc) Unmarshal(data []byte) error {
	return readLSB(
